...
$alert = "<br><div class='card text-white bg-info'><div class='card-body'>Il semble que votre adhésion a expiré le ".date_i18n('d/m/Y', $adherent->datefin).". Afin de ne pas perdre vos avantages, renouvelez <a href='".doliconnecturl('doliaccount')."?module=membership' class='alert-link'>en cliquant -ici-</a>.</div></div>";
} elseif ($time>$adherent->datefin && $adherent->statut == '1' && empty($adherent->datefin!=null)) {
$alert = "<br><div class='card text-white bg-info'><div class='card-body'>Il semble que vous n'avez pas encore réglé votre adhésion. Afin de bénéficier de vos avantages, finalisez <a href='".doliconnecturl('doliaccount')."?module=membership' class='alert-link'>en cliquant -ici-</a>.</div></div>";
} elseif ($time>$adherent->next_subscription_renew && $time<$adherent->datefin && $adherent->statut == '1') {
$alert = "<BR><div class='card text-white bg-info'><div class='card-body'>Il semble que votre adhésion expire le ".date_i18n('d/m/Y', $adherent->datefin).". Afin de ne pas perdre vos avantages, renouvelez <a href='".doliconnecturl('doliaccount')."?module=membership' class='alert-link'>en cliquant -ici-</a>.</div></div>";
}
