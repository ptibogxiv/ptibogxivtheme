    ...
    elseif(is_active_sidebar('sidebar-left-widget-area') OR is_active_sidebar('sidebar-right-widget-area')): ?>col-12 col-md-8<?php 
      ...
      <div id="content" role="main">
        ...
        <div class="alert alert-warning">
          <h1><i class="glyphicon glyphicon-warning-sign"></i> <?php _e('Error', 'ptibogxivtheme'); ?> 404</h1>
          <p><?php _e('The page you were looking for does not exist.', 'ptibogxivtheme'); ?></p>
        </div>
      </div><!-- /#content -->
    </div>
