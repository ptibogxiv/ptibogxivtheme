...
<BR></DIV><DIV class="col-12 col-md-3">
...
<DIV class="row">
<DIV class="col"><P class="text-center"><SPAN class="fas fa-copyright"></SPAN> <?php echo date('Y'); ?> <?php echo bloginfo('name'); ?> - Tous droits réservés<BR><SMALL><?php _e('Theme by', 'ptibogxivtheme'); ?> <A href="https://www.ptibogxiv.net" class="text-info">ptibogxiv.net</A></SMALL></P></DIV>
</DIV></DIV></FOOTER>
<?php wp_footer();
...
<DIV class="modal-body"><DIV class="card"><UL class="list-group list-group-flush">
<?php  
$translations = pll_the_languages( array( 'raw' => 1 ) );
foreach ($translations as $key => $value) {
?>
<A href='<?php echo $value[url]; ?>' class='list-group-item list-group-item-action list-group-item-light'>
