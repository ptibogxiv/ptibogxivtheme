...
<BR><DIV class="card border-light shadow-lg" style="background-color: rgba(256, 256, 256, 0.8)"><DIV class="card-body"><?php dynamic_sidebar('sidebar-left-widget-area'); ?></DIV></DIV><BR>
    </DIV>
<?php } ?>  
...
<BR><DIV class="card border-light shadow-lg" style="background-color: rgba(256, 256, 256, 0.8)"><DIV class="card-body"><?php echo $sidebar_pos; get_sidebar(); ?></DIV></DIV><BR>
    </DIV>
<?php } ?>
  </div><!-- /.row -->
</div><!-- /.container -->
