...
<?php } 
if ( !empty(get_option('doliconnectbeta')) && function_exists('doliconnecturl') && doliconnectid('dolicart') > 0 ) { 
...
<?php if (function_exists('doliconnect_CartItemsList')) { ?><div id="DoliHeaderCartItemsList"><?php echo doliconnect_CartItemsList(); ?></div>
